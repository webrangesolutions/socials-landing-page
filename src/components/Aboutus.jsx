...
const Aboutus = () => {
  return (
    <div className="relative h-[1998px] sm:mb-20 sm:h-fit overflow-y-hidden overflow-x-hidden">
      <img
        src={bg}
        className="absolute top-0 left-0 z-10 w-[432px] sm:object-cover sm:w-[130px] sm:h-[600px] h-[1728px] my-20 ml-5"
      />
      <div className="pt-40 sm:pt-20 sm:pl-10 sm:pr-2 pl-20 pr-10 z-20 relative">
        <div className="w-[100%] overflow-x-hidden flex sm:flex sm:flex-col sm:items-start items-center">
          <div className="w-[45%] xl:w-[44%] sm:w-[80%]">
            <h1
              ...
              className="text-[54px] text-[#FFF528] mb-2 xl:text-[45px]  lg:text-5xl sm:text-xl md:text-2xl w-[80%] xl:w-[90%] lg:w-[80%] md:w-[80%] sm:w-[82%]  font-semibold leading-[60px] xl:leading-[50px] lg:leading-[50px]  sm:leading-10 md:leading-10"
            >
              ABOUT US
            </h1>
            <p className="font-league-spartan text-[24px]  xl:text-[18px] sm:text-sm  text-white mb-10 sm:mb-2 w-[95%] leading-[30px] xl:leading-[30px] xl:w-[95%]">
              ...
              between sports fans and broadcasters. Founded by a team of
              passionate sports enthusiasts and media experts, vupop leverages
              cutting-edge technology to amplify the voices of fans and enhance
              the reach of broadcasters
            </p>
          </div>
          <div className="w-[55%] xl:w-[70%] sm:w-[100%] flex sm:items-end justify-end">
            <img
              src={aboutus}
              className="sm:h-[100px] sm:w-full sm:object-cover"
            />
          </div>
        </div>
        ...
        <div className="w-full flex flex-col mt-64 sm:mt-20 items-center justify-center">
          ...
          <p className="font-league-spartan text-[24px]  xl:text-[18px] text-center  text-white mb-14 sm:mb-6 w-[45%] sm:w-[80%] leading-[30px] xl:leading-[30px] xl:w-[50%]">
